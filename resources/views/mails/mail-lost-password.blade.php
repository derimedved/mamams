                ...
                <tr>
                  <td valign="top">
                    <table style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%; margin: 0 auto; width: 100%; height: 321px" width="100%" border="0" cellpadding="0" cellspacing="0">
                      <tbody>
                        <tr>
                          <td style="background-image: url({{ get_template_directory_uri() }}/assets/mails/img/bg8.jpg); height: 321px" background="{{ get_template_directory_uri() }}/assets/mails/img/bg8.jpg" bgcolor="#ffffff" width="640" height="321" valign="top">
                            <!--[if gte mso 9]>
                            <v:rect xmlns:v="urn:schemas-microsoft-com:vml" fill="true" stroke="false" style="width:640px;height:321px;">
                              <v:fill type="tile" src="{{ get_template_directory_uri() }}/assets/mails/img/bg8.jpg" color="#ffffff" />
                                  ...
                                  <tr>
                                    <td valign="top" align="center" style="padding: 0">
                                      <table border="0" cellpadding="0" cellspacing="0" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 300px" width="300" align="center">
                                        <tbody>
                                          <tr>
                                            <td valign="top" style="padding: 20px 0 20px; text-align: center">
                                          ...
                                          <tr>
                                            <td valign="top" style="padding: 0 0 20px; text-align: center">
                                              <p style="margin-top: 0; margin-bottom: 0; font-family: 'Work Sans', Arial, Helvetica, sans-serif; font-size: 18px; line-height: 24px; font-weight: 400; color: #000000">
                                                <!--[if (gte mso 9)|(IE)]><font style="font-family: Arial, Helvetica, sans-serif;"><![endif]-->
                                                Pas de soucis, ça arrive. Cliquez sur le bouton ci dessous pour réinitialiser votre mot de passe
                                                <!--[if (gte mso 9)|(IE)]></font><![endif]-->
                                              </p>
                                            </td>
                                          </tr>
                                          <tr>
                                            <td style="padding: 0" align="center">
                                              <div style="margin: 0; font-family: 'Work Sans', Arial, Helvetica, sans-serif; text-align: center; line-height: 12px">
                                                <a href="{{ $reset_link }}" class="button" target="_blank" style="background-color: #cb5050; text-decoration: none; padding: 9px 30px 9px; color: #ffffff; font-weight: 400; display: inline-block; font-size: 15px; text-transform: uppercase; mso-padding-alt: 0; text-underline-color: #cb5050; border-radius: 1px">
                                                  <!--[if (gte mso 9)|(IE)]><i style="letter-spacing: 30px; mso-font-width: -100%; mso-text-raise: 10pt">&nbsp;</i><font style="font-family: Arial, Helvetica, sans-serif;"><![endif]-->
                                                  <span style="mso-text-raise: 5pt">Réinitialiser</span>
                                                  <!--[if (gte mso 9)|(IE)]></font><i style="letter-spacing: 30px; mso-font-width: -100%">&nbsp;</i><![endif]-->
                                                </a>
                                              </div>
                                            </td>
                                          </tr>
