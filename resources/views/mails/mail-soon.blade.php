                ...
                <tr>
                  <td valign="top">
                    <table style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%; margin: 0 auto; width: 100%; height: 321px" width="100%" border="0" cellpadding="0" cellspacing="0">
                      <tbody>
                        <tr>
                          <td style="background-image: url({{ $path }}/img/bg9.jpg); height: 321px" background="{{ $path }}/img/bg9.jpg" bgcolor="#ffffff" width="640" height="321" valign="top">
                            <!--[if gte mso 9]>
                            <v:rect xmlns:v="urn:schemas-microsoft-com:vml" fill="true" stroke="false" style="width:640px;height:321px;">
                              <v:fill type="tile" src="{{ $path }}/img/bg9.jpg" color="#ffffff" />
                                ...
                                <tbody>
                                  <tr>
                                    <td valign="top" align="center" style="padding: 0">
                                      <table border="0" cellpadding="0" cellspacing="0" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 360px" width="360" align="center">
                                        <tbody>
                                          <tr>
                                            <td valign="top" style="padding: 30px 0 20px; text-align: center">
                                          ...
                                          <tr>
                                            <td valign="top" style="padding: 0 0 59px; text-align: center">
                                              <p style="margin-top: 0; margin-bottom: 0; font-family: 'Work Sans', Arial, Helvetica, sans-serif; font-size: 18px; line-height: 24px; font-weight: 400; color: #232120">
                                                <!--[if (gte mso 9)|(IE)]><font style="font-family: Arial, Helvetica, sans-serif;"><![endif]-->
                                                Vous vous êtes inscrite au cours
                          ...
                          <td style="padding:0; text-align:center;">
                            <table border="0" cellpadding="0" cellspacing="0" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%" width="100%">
                                <tbody>
                                  <tr>
                                            <td valign="top" style="padding: 0 0 20px; text-align: center">
                                              <p style="margin-top: 0; margin-bottom: 0; font-family: 'Work Sans', Arial, Helvetica, sans-serif; font-size: 16px; line-height: 20px; font-weight: 400; color: #cb5050">
                                                <!--[if (gte mso 9)|(IE)]><font style="font-family: Arial, Helvetica, sans-serif;"><![endif]-->
                                                Nous vous tiendrons au courant. Le cours arrive bientôt !
                                                <!--[if (gte mso 9)|(IE)]></font><![endif]-->
                                              </p>
                                            </td>
                                          </tr>
