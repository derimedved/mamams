  ...
  <head>
    ...
    <style type="text/css">
      ...
      @font-face {
        ...
        src: url('{{ $path }}/fonts/fontsfree-net-zxss.eot?#iefix') format('embedded-opentype'),
            url('{{ $path }}/fonts/fontsfree-net-zxss.woff2') format('woff2'),
            url('{{ $path }}/fonts/fontsfree-net-zxss.woff') format('woff'),
            url('{{ $path }}/fonts/fontsfree-net-zxss.ttf') format('truetype'),
            url('{{ $path }}/fonts/fontsfree-net-zxss.svg#urwclassicow01-regularregular') format('svg');
        font-weight: normal;
        font-style: normal;
      }
      #outlook a {
          ...
          <td align="center" style="padding: 0">
            ...
            <table class="outer" align="center" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%; margin: 0 auto; max-width: 640px" width="100%" border="0" cellpadding="0" cellspacing="0">
              <tbody>
                <tr>
                  <td valign="top">
                    <table style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%; margin: 0 auto; width: 100%; height: 328px" width="100%" border="0" cellpadding="0" cellspacing="0">
                      <tbody>
                        <tr>
                          <td style="background-image: url({{ $path }}/img/bg3.jpg); height: 328px;" background="{{ $path }}/img/bg3.jpg" bgcolor="#ffffff" width="640" height="328" valign="top">
                            <!--[if gte mso 9]>
                            <v:rect xmlns:v="urn:schemas-microsoft-com:vml" fill="true" stroke="false" style="width:640px;height:328px;">
                              <v:fill type="tile" src="{{ $path }}/img/bg3.jpg" color="#ffffff" />
                                          ...
                                          <tr>
                                            <td valign="top" style="padding: 0; text-align: center;">
                                              <p style="margin-top: 0; margin-bottom: 0; font-family: 'Work Sans', Arial, Helvetica, sans-serif; font-size: 18px; line-height: 24px; font-weight: 400; color: #000000">
                                                <!--[if (gte mso 9)|(IE)]><font style="font-family: Arial, Helvetica, sans-serif;"><![endif]-->
                                                  Patricia, vous avez réussi votre inscription à l’avant première des cours de l’école des futures mamans
                                                <!--[if (gte mso 9)|(IE)]></font><![endif]-->
                                              </p>
                                            </td>
                                          </tr>
