...
// $response->result->id gives the orderId of the order created above
    ...
    public function getAgreementState($token='') {
        ...
        $next_billing_date = strtotime('+1 day', strtotime($details->next_billing_date));
    ...
    public function getAgreementNextDate($id) {
    ...
    public function createPlan($item=[],$return_url='',$cancel_url='',$apiContext, $term='', $user_id='', $order_id) {
     ...
     //   ->setAmount(new Currency(array('value' => 0.1, 'currency' => $item['currency'])));
        ...
        try {
            ...
            update_field( 'paypal_test', $log. "\n" . '-----' ."\n". 'cPlan --- '. $cPlan->getId(), 'options' );
    ...
    public function createSubscription($item=[],$return_url='',$cancel_url='', $term, $user_id='', $order_id='') {

        $apiContext = $this->getApiContext($this->clientId, $this->clientSecret);


        $cPlan = $this->createPlan($item,$return_url,$cancel_url,$apiContext,$term, $user_id, $order_id);
